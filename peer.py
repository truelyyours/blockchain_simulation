...
class Block():
    ...
    def __init__(self, prev_hash, merkel_root, timestamp, parent=None, is_adversary=0):
    ...
    def __repr__(self):
        return ",".join([self.prev_hash, '0000', self.timestamp, str(int(self.is_adversary))])
...
class PeerNode():
    ...
    def mining_function(self):
        ...
        new_block = Block(prev_hash, "0000", str(int(utctime())))
